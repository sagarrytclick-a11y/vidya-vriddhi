...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages = [
    ...
    { url: `${domain}/site-map`, priority: 0.4, changeFrequency: 'weekly' as const },
    { url: `${domain}/career`, priority: 0.5, changeFrequency: 'monthly' as const },
    { url: `${domain}/compare-colleges`, priority: 0.7, changeFrequency: 'weekly' as const },
    { url: `${domain}/online-mba`, priority: 0.8, changeFrequency: 'weekly' as const },
    { url: `${domain}/btech`, priority: 0.8, changeFrequency: 'weekly' as const },
    { url: `${domain}/neet-rank-predictor`, priority: 0.7, changeFrequency: 'monthly' as const },
